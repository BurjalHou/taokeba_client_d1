...
import com.taokeba.fragment.RegistBasicFragment;
...
public class RegistBasicPage extends Page {
    ...
    public RegistBasicPage(ModelCallbacks callbacks, String title) {
        super(callbacks, title);
    }

    @Override
    public Fragment createFragment() {
        return RegistBasicFragment.create(getKey());
    }
