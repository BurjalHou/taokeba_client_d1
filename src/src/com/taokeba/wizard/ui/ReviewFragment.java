    ...
    private class ReviewAdapter extends BaseAdapter {
        ...
        public View getView(int position, View view, ViewGroup container) {
            ...
            if (TextUtils.isEmpty(value)) {
                value = RegisterConfig.REGISTER_INPUT_NONE;
            }
             ...
             */
            if(position==0) {
            	RegisterConfig.userID = value;
            } else if(position == 1) {
            	RegisterConfig.name = value;
            } else if(position == 2) {
            	RegisterConfig.nickName = value;
            } else if(position == 3) {
            	RegisterConfig.qqNum = value;
            	RegisterConfig.email = value + "@qq.com";
            } else if(position == 4) {
            	RegisterConfig.password = value;
            } else if(position == 5) {
            	RegisterConfig.passwordRepat = value;
            } else if(position == 6) {
            	RegisterConfig.type = value;
            } else if(position == 7) {
            	RegisterConfig.departmentID = value;
            } else if(position == 8) {
            	RegisterConfig.major = value;
            } else if(position == 9) {
            	RegisterConfig.stuClass = value;
            } else if(position == 10) {
            	RegisterConfig.entranceYear = value;
            } else if(position == 11) {
            	RegisterConfig.graduateDate = value;
            }
